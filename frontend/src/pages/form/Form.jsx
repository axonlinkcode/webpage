        ...
        <div className="form-container">
            ...
            <div className='form-card'>
                ...
                <p className="intro-text">
                   We are developing a new mobile-friendly system to help patients in Nigeria and across Africa find specialist care more easily and discover relevant clinical trials. Your responses will directly inform how we build this system to meet your needs. All your answers will be kept confidential.
                </p>
