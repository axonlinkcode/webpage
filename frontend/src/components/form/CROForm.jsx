...
const CROForm = () => {
  ...
  const validateCurrentStep = () => {
    ...
    if (Array.isArray(value) && value.length === 0) {
      ...
      currentStep === 17 &&
      formData.hasPrivacyConcerns === "Yes" &&
  ...
  const handleNext = () => {
    ...
    if (
      (currentStep === 16 && formData.useDigitalSystems === "No") ||
      formData.useDigitalSystems === "Not sure"
    ) {
      setCurrentStep(18);
      return;
    }
  ...
  const handleBack = () => {
    ...
    if (
      (currentStep === 18 && formData.useDigitalSystems === "No") ||
      formData.useDigitalSystems === "Not sure"
    ) {
      setCurrentStep(16);
      return;
    ...
    switch (currentStep) {
      ...
      case 3:
        return (
          <div className="form-group">
            <label>
              3. How many years of experience do you have working in clinical
              trials?
            </label>
            {[
              "Less than 2 years",
      ...
      case 4:
        return (
          <div className="form-group">
            <label>
              4. In which regions of Africa does your organization primarily
              conduct clinical trials? (Select all that apply)
            </label>
            {[
      ...
      case 5:
        return (
          <div className="form-group">
            <label>
              5. What trial phases does your organization typically manage or
              sponsor in Nigeria/Africa ? (Select all that apply){" "}
            </label>
            {[
              "Phase I",
              "Phase II",
            ...
            {errors.trialPhases && (
              <span className="error">{errors.trialPhases}</span>
            )}
          </div>
        );
      case 6:
        return (
          <div className="form-group">
            <label>
              6. How do you currently identify and select suitable clinical
              trial sites in Nigeria/Africa? (Select all that apply){" "}
            </label>
            {[
            ...
            {errors.siteSelectionMethods && (
              <span className="error">{errors.siteSelectionMethods}</span>
            )}
          </div>
        );
      case 7:
        return (
          <div className="form-group">
            <label>
              7. How challenging is the process of identifying and activating
              suitable clinical trial sites in Nigeria or across Africa?
              <span className="form-group-span">
                (5.Extremely Challenging, 1.Not Challenging)
              </span>
            </label>
      ...
      case 8:
        return (
          <div className="form-group">
            <label>
              8. What are the biggest challenges you face when managing ongoing
              clinical trial operations or communication with sites in
              Nigeria/Africa? (Select up to 3){" "}
            </label>
            {[
            ...
            {errors.challenges && (
              <span className="error">{errors.challenges}</span>
            )}
          </div>
        );
      case 9:
        return (
          <div className="form-group">
            <label>
              9. How challenging is patient recruitment and enrolment for your
              trials in Nigeria or across Africa?
              <span className="form-group-span">
                {" "}
                (5.Extremely Challenging, 1.Not Challenging)
              </span>
      ...
      case 10:
        return (
          <div className="form-group">
            <label>
              10. Please briefly describe a specific data flow bottleneck or
              communication gap you've encountered that is unique to (or
              particularly pronounced in) clinical trials conducted in Africa.
            </label>
            <textarea
      ...
      case 11:
        return (
          <div className="form-group">
            <label>
              11. Do you currently use any digital systems or platforms for
              managing your clinical trial operations (e.g., EDC, CTMS, mobile
              data capture, eTMF)?
            </label>
            {["Yes", "No"].map((option, i) => (
              <div key={i}>
            ...
            {errors.useDigitalSystems && (
              <span className="error">{errors.useDigitalSystems}</span>
            )}
          </div>
        );
      case 12:
        ...
        return (
          <div className="form-group">
            <label>
              11a. Which types of digital systems do you primarily use for trial
      ...
      case 13:
        ...
        return (
          <div className="form-group">
            <label>
              12. Overall, how well do your current digital systems meet your
              operational needs for managing clinical trials in Nigeria or
              across Africa?
              <span className="form-group-span">
      ...
      case 14:
        return (
          <div className="form-group">
            <label>
              13. What are the main limitations or issues you encounter with
              your existing digital tools (or reasons you don't use them)?
            ...
            {errors.limitations && (
              <span className="error">{errors.limitations}</span>
            )}
          </div>
        );
      case 15:
        return (
          <div className="form-group">
            <label>
              14. How reliable are internet and power at the clinical trial
              sites you work with in Nigeria or across Africa?
              <span className="form-group-span">
                (5.Very Reliable, 1.Unreliable)
              </span>
            </label>
            <div className="rating-scale">
              {[1, 2, 3, 4, 5].map((num) => (
      ...
      case 16:
        return (
          <div className="form-group">
            <label>
              15. Have staff or participants at your trial sites expressed
              significant concerns about data privacy or trust when using
              digital tools for clinical trial activities?{" "}
            </label>
            ...
            {errors.hasPrivacyConcerns && (
              <span className="error">{errors.hasPrivacyConcerns}</span>
            )}
          </div>
        );
      case 17:
        return (
          <div className="form-group">
            <label>
              15a. Please briefly describe the nature of those concerns:
            </label>
            <textarea
      ...
      case 18:
        return (
          <div className="form-group">
            <label>
              16. What are your general perceptions of the current IT
              infrastructure and digital readiness of healthcare facilities and
              professionals at clinical trial sites in Nigeria or across Africa?
              <span className="form-group-span">
                (5.High Readiness, 1.Poor Readiness)
              </span>
            </label>
            <div className="rating-scale">
              {[1, 2, 3, 4, 5].map((num) => (
      ...
      case 19:
        return (
          <div className="form-group">
            <label>
              17. Which of the following new IT features or functionalities
              would most significantly improve your ability to conduct or manage
              clinical trials in Nigeria/Africa? (Select up to 3 most impactful
              features)
            </label>
            {[
      ...
      case 20:
        return (
          <div className="form-group">
            <label>
              18. How useful would an AI tool be to help match local patient
              data to study eligibility criteria (assuming robust data privacy
              and ethical considerations are in place)?
              <span className="form-group-span">
                (5.Very Usefull, 1.Not Usefull)
              </span>
            </label>
            <div className="rating-scale">
              {[1, 2, 3, 4, 5].map((num) => (
      ...
      case 21:
        return (
          <div className="form-group">
            <label>
              19. Are you open to investing in and integrating with new digital
              platforms developed specifically for the unique context and
              challenges of clinical research in Nigeria or across Africa?{" "}
            </label>
            {[
              "Yes, definitely",
            ...
            {errors.investInNewPlatforms && (
              <span className="error">{errors.investInNewPlatforms}</span>
            )}
          </div>
        );
      case 22:
        const handlePriorityClick = (index) => {
          ...
          if (newPriorities[index] !== undefined) {
            // Remove it
            newPriorities = newPriorities.map((val) =>
              val === newPriorities[index] ? undefined : val
            );
          } else {
        ...
        return (
          <div className="form-group">
            <label>
              20. Please rank the following areas of improvement by clicking on
    ...
    <div className="survey-body">
      ...
      <form onSubmit={handleSubmit} className="survey-form">
        ...
        <div className="survey-header">
          ...
          <p>
            Your expertise as a clinical trial manager or sponsor operating in
            Africa is critical. We are developing an innovative IT system to
            streamline clinical trial operations, enhance patient engagement,
            and improve connectivity within Nigeria and across the African
            healthcare and research ecosystem.{" "}
          </p>
          <p>
            Your valuable insights will directly inform the features and
            functionality of this system. Your answers will be kept
            confidential.{" "}
          </p>
        </div>
